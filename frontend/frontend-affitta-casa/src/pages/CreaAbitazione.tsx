    ...
    return (
        <div style={{
            ...
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                <h2 style={{ color: 'white', textAlign: 'center', marginBottom: '30px' }}>Aggiungi Nuova Abitazione</h2>

                <form onSubmit={gestisciSalvataggio} style={{
                    display: 'flex',
                    ...
                    <label style={{ fontWeight: 'bold', color: 'white' }}>Codice Identificativo Host:</label>
                    <input
                        required
                        type="text"
                    ...
                    <label style={{ fontWeight: 'bold', color: 'white' }}>Nome Abitazione:</label>
                    <input
                        required
                        type="text"
                        value={form.nome}
                    ...
                    <label style={{ fontWeight: 'bold', color: 'white' }}>Indirizzo:</label>
                    <input
                        required
                        type="text"
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
                        <div>
                            <label style={{ fontWeight: 'bold', color: 'white' }}>Locali:</label>
                            <input
                                type="number"
                                min="1"
                                value={form.n_locali}
                        ...
                        <div>
                            <label style={{ fontWeight: 'bold', color: 'white' }}>Posti Letto:</label>
                            <input
                                type="number"
                                min="1"
                        ...
                        <div>
                            <label style={{ fontWeight: 'bold', color: 'white' }}>Piano:</label>
                            <input
                                type="number"
                                value={form.piano}
